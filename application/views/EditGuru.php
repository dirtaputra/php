...
<html>
	...
	<div class="col-md-9">
			<form action="<?php echo base_url(). 'index.php/Crud_guru/do_update'; ?>" method="post" class="form-horizontal">
				<div class="form-group">
					<label class="control-label col-sm-2" for="nip">Nip :</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" name="nip" value="<?php echo $u->nip ?>" required>
					</div>
				</div>
				<div class="form-group">
